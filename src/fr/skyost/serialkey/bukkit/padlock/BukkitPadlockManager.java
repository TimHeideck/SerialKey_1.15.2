...
public class BukkitPadlockManager extends PluginPadlockManager<ItemStack, Location> {
	...
	public boolean fixLocation(final SerialKeyLocation location) {
		...
		if(block.getState() instanceof Chest) {
			final InventoryHolder holder = ((Chest)block.getState()).getInventory().getHolder();
			if(holder instanceof DoubleChest) {
				final SerialKeyLocation left = pluginLocationToSerialKeyLocation(((Chest)((DoubleChest)holder).getLeftSide()).getLocation());
				...
				final SerialKeyLocation right = pluginLocationToSerialKeyLocation(((Chest)((DoubleChest)holder).getRightSide()).getLocation());
